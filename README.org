...
*** Installation of Dependencies  
    ...
    The [installation.txt](https://github.com/schymane/RChemMass/blob/master/README_installation.txt) can be referred for installing the dependencies.

*** Alternate option to download shinyscreen
    The [shinyscree](https://git-r3lab.uni.lu/eci/shinyscreen) can be downloaded(~tar.gz~) from the gitlab and installed into the Rstudio. 
