...
*** Installation of Dependencies  
    ...
    please refer the link for installing the dependencies *[Installation help](https://github.com/schymane/RChemMass/blob/master/README_installation.txt)*. 

*** Alternate option to download shinyscreen
    The shinyscreen package can be downloaded(~tar.gz~) from gitlab *[shinyscreen](https://git-r3lab.uni.lu/eci/shinyscreen)*.
    The package archive is installed and script given below runs the shinyscreen. 
