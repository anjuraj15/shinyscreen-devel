...
*** Installation of Dependencies  
    ...
    please refer the link for installing the dependencies [[https://github.com/schymane/RChemMass/blob/master/README_installation.txt][Installation help]]

*** Alternate option to download shinyscreen
    The shinyscreen package can be downloaded(~tar.gz~) from gitlab https://git-r3lab.uni.lu/eci/shinyscreen)*.
