...
<!-- <div style="width: 80%; overflow-y: scroll;"> <\!-- EIC ID Plot -\-> -->
<!-- ```{r,echo=F} -->
<!-- plotOutput("plot_eic_combined", -->
<!--            ## height="100%", -->
<!--            hover = hoverOpts(id="plot_hover", -->
<!--                              delayType = "throttle", -->
<!--                              delay=100), -->
...
<!-- ``` -->
<!-- </div> <\!-- EIC ID Plot -\-> -->
<!-- <div style="display: flex; flex-direction: column; width=20%;">  <\!-- Structure and Dynamic Plot Data -\-> -->

<!-- ```{r, echo=F} -->
<!-- plotOutput("plot_struct", width="400%") -->
<!-- ``` -->



<!-- </div>  <\!-- Structure and Dynamic Plot Data -\-> -->

<!-- </div>  <\!-- EICs and Structure -\-> -->

<!-- <div style="display: flex; flex-direction: row; flex-wrap: nowrap;"> <\!-- Spec and Details-\-> -->

<!-- <div style="display: flex; flex-direction: row; flex-wrap: nowrap; padding-top: 2em; padding-left: 2em;">  <\!-- Modification -\-> -->
<!-- <div> <\!-- Select MS1 curve -\-> -->
<!-- ```{r,echo=F} -->
<!-- selectInput(inputId="sel_ms1_curve",label="Select MS1 curve",choices=NULL) -->
<!-- numericInput(inputId="mod_ms1_rt",label="MS1 peak retention time (min)",value=NA_real_) -->
<!-- numericInput(inputId="mod_ms1_int", label="MS1 peak intensity", value=NA_real_) -->
<!-- checkboxGroupInput(inputId="mod_ms1_qa", label="MS1 Quality") -->
<!-- ``` -->
<!-- </div> <\!-- Select MS1 curve -\-> -->
<!-- <div> <\!-- Select MS2 entry -\-> -->
<!-- ```{r,echo=F} -->
<!-- selectInput(inputId="sel_ms2_entry",label="Select MS2 spectrum",choices=NULL) -->
<!-- checkboxGroupInput(inputId="mod_ms2_qa", label="MS2 Quality") -->
<!-- actionButton(inputId="change_qa_b",label="Commit changes") -->
<!-- ``` -->
<!-- </div> <\!-- Select MS2 entry -\-> -->
<!-- </div> <\!-- Modification -\-> -->
<!-- </div> <\!-- Spec and Details-\-> -->
