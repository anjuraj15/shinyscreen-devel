...
A project is a directory under the path specified using the `userdir`
argument of the `app` function. It contains all the intermediate data,
records of the project state and the outputs of the analysis.

Create a completely new project by typing its name and clicking on the
`Create` button.
</details>
