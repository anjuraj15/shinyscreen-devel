...
<div style="display: flex; flex-flow: column wrap; vertical-align: bottom;">
...
### Compound Index
<div style="display: flex; flex-flow: row nowrap; overflow-y: scroll">


<div style="width: 12%; background-color: var(--lt-gr-bg); vertical-align: bottom;">
#### Arrange
...
</div> <!-- Arrange Compound Index -->

<div style="width:75%; vertical-align: bottom;">
#### Compounds
```{r, echo=F}
DT::DTOutput("cindex")
```
</div> <!-- Compound Index Table -->
</div> <!-- Compound Index -->
